...
;with total as (select d.name Distributor,cm.PJP,ph.LDESC 'Route',--convert(varchar, cm.DOC_DATE, 23) Doc_date
...
--and p.poptype='01'
group by d.name,cm.PJP,ph.LDESC--,cm.DOC_DATE  --p.poptype
)
