...
(C.QTY1) CS,(QTY2) DZ, (QTY3)  PC, Convert(int, (C.QTY1*s.SELL_FACTOR1)+(QTY2*s.SELL_FACTOR2)+(QTY3)) 'Total number in PCs',convert(float, round( c.amount*1.15,2)) 'GSV',TOT_DISCOUNT 
...
cm.Delv_date between '20190523'and  '20190607'
