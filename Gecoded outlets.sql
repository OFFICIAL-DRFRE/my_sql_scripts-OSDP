...
C.PHONE, CG.GEOCODEX, CG.GEOCODEY SYNCKEY, GEOCODEDATE 'GEO CODE DATE', COUNT(CG.CUSTOMERCODE) OVER (PARTITION BY CG.ROUTECODE) AS TOTAL_BY_PJP,
O.LONGITUDE, O.LATITUDE, COUNT(CG.CUSTOMERCODE) OVER () AS TOTAL
