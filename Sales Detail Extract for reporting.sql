...
select 
	cm.distributor 'KD Code',CM.POP_NAME 'Outlet Name',
	SE.CHANNEL 'Channel Type', cm.DOC_DATE, C.DOC_NO,year(c.DOC_DATE) 'Year'
,	Month(c.DOC_DATE)'Month',S.LDESC 'SKU Name' ,c.sku,c.amount 'GSV',(
...
where cm.sub_document in ('01','02','04') 
	and cm.document ='cm' 
	and cm.visit_type = '02' 
	and cm.Delv_date between @datefrom and @dateto 
