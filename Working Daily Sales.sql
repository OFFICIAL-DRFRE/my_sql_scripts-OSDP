DECLARE @DOCDATEFROM DATE = '1-October-2021',
        @DOCDATETO DATE = '2-October-2021',
        @DDOCDATEFROM DATE = '1-October-2021',
        @DDOCDATETO DATE = '2-October-2021',
...
sales as (Select 
    ...
    NIV =CMD.AMOUNT+ISNull(DISCOUNT.Amount,0)*1.15, --ISNull(DISCOUNT.Amount,0),
    '4' frequencyOfVisit,
    0 as FREE_INDICATOR,
    'PC' as Unit_MEASURE,
    LATITUDE,
...
'15550390',
'15550388',
'15307900') and s.PROD5 not in ('310101001',
'390101001',
'310104E16',
'31020CE16',
'310260E16',
'390104E16','310982E16')
 ...
 select DistributorID,InvoiceDate,Channel,Material,sum(Volume) as Volume,sum(GSV) as GSV,sum(NIV) as NIV
 from sales where NIV !=0
 group by DistributorID,InvoiceDate,Channel,Material