...
Declare @dateFrom date ='01-feb-2021'
Declare @dateto   date ='15-feb-2021'
select cm.distributor 'KD Code',d.NAME 'KD Name',CM.POP_NAME 'Outlet Name',SE.LDESC 'Channel Type',
cm.town+cm.locality+cm.slocality+cm.POP 'POP_code', convert (varchar,cm.DOC_DATE,23) DOC_DATE, C.DOC_NO,year(cm.DOC_DATE) 'Year',
Month(cm.DOC_DATE)'Month',pj.pjp as  'pjp',ds.NAME AS NAME,S.LDESC 'SKU Name' ,c.sku,c.amount 'GSV',
