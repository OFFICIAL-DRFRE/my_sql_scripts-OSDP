...
SELECT 
	CG.TENANTCODE DT_CODE, P.PJP, 
	P.LDESC PJP_DESC, CG.CUSTOMERCODE, 
	C.CUSTOMERNAME,C.ADDRESS1+' '+ C.ADDRESS2 AS ADDRESS,
	C.PHONE, CG.GEOCODEY, CG.GEOCODEX, SYNCKEY, GEOCODEDATE 'GEO CODE DATE', 
	COUNT(CG.CUSTOMERCODE) OVER (PARTITION BY CG.ROUTECODE) AS TOTAL_BY_PJP,
